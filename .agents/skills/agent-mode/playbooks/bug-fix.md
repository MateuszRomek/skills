...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to a subagent using the configured `bug-fix` role, or inherited parent settings when absent. Give it a specific scope and review the diff.
