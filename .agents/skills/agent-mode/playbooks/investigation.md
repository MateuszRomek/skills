...
This playbook stays read-only and does not publish. Do not run `architect` unless the investigation precedes a code change. If it does, hand back to the user and re-route to Bug fix or Feature.
