...
1. Use the **skill-creator** and **writing-for-agents** skills.
2. Validate the skill: frontmatter has `name` and `description`, referenced files exist, cross-skill links resolve.
3. Test cases if structural; skip if subjective.
4. Finish with verified local changes. Leave commit and publication to the user's explicit delivery request.
