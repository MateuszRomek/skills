...
- **Attack the Premise** (**principle-attack-the-premise**). Two or more fixes that share one premise have failed the same gate. Count which actors hold the imbalance, then question the premise before writing another fix that assumes it.
