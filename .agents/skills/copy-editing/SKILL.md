---
name: copy-editing
description: Edit, review, or refresh existing marketing copy while preserving its message and voice. Use for copy feedback, proofreading, tightening, and content refresh. For writing new page copy, use copywriting.
metadata:
  version: 2.0.0
---
...
| Structural or strategic page changes | Review the page strategy before editing copy |
